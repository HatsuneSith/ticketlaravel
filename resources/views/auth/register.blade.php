                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group">
                          <label for="select" class="col-md-4 control-label">Departamento</label>
                          <div class="col-lg-6">
                            <select class="form-control" id="select1" name="departamento">
                        ...
                        <div class="form-group">
                          <label for="select" class="col-md-4 control-label">Rol</label>
                          <div class="col-lg-6">
                             <select class="form-control" id="select2" name="rol">
